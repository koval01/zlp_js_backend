const crypto = require('crypto'), {input_e} = require("../errors"), {get_player_auth} = require("../../database/functions/get_player"),
    // start context
    getTelegramValidateHash = (authData) => {
    ...
    }, getVerifiedTelegramData = (json_body, custom_var = false) => {
        let authData
        if (custom_var) {
            authData = json_body
        } else {
